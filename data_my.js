...
export class AntData {
  ...
  async load() {
    ...
    const imgRequest = new Promise((resolve, reject) => {
      ...
      img.src = ANT_IMAGES_SPRITE_PATH;
    });

    const labelsRequest = fetch(ANT_LABELS_PATH);
...
const datasetPath = 'путь_к_папке_обработанных_изображений';
const dataset = await createDataset(datasetPath);

// Теперь вы можете использовать датасет для обучения вашей нейронной сети
Замените 'класс_вашего_изображения' на имя класса, к которому принадлежит ваше изображение. Также уточните свою логику меток классов в соответствии с вашими потребностями.
